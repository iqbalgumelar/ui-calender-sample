...
application_name = "Mysiloam-uat-ecs-msm-fe-calendar"
short_name = "msm-fe-calendar"
region = "ap-southeast-3"

environment = "uat"
# environment = "dev"

subnet_ids = ["subnet-097393e07c11e7fe8", "subnet-0e29f3215ec338d42"]

#####################################################################################
# Parameters for ECS Cluster Information

# ecs_cluster_name = "mysiloam-dev-cluster"
ecs_cluster_name = "Mysiloam-uat-ecs-iac"


#####################################################################################
# Parameters for Service Details

service_name = "Mysiloam-uat-ecs-msm-fe-calendar"
...
container_definitions = {
  Mysiloam-uat-ecs-msm-fe-calendar = {
    image   = "{{ image }}"
    port_mappings = [
      {
        name          = "mysiloam-uat-ecs-msm-fe-calendar"
        containerPort = 80
        protocol      = "tcp"
        appProtocol   = "http"
      }
...
load_balancer = {
  service = {
    ...
    target_group_arn = "arn:aws:elasticloadbalancing:ap-southeast-3:643749679320:targetgroup/Mysiloam-iac-alb-msm-fe-calendar/18fe3d651e24a596"
    container_name   = "Mysiloam-uat-ecs-msm-fe-calendar"
    container_port   = 80
  }
}
...
capacity_provider_strategy = {
    ...
    mysiloam-ec2-ondemand-small = {
      capacity_provider = "mysiloam-ec2-ondemand_pas"
      weight            = 1
      base              = 1
    }
}
